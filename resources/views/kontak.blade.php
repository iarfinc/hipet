...
@section('contents')
    <div class="back-button">
        <a href="http://127.0.0.1:8000/dashboard">
            <i class="fas fa-chevron-left"></i><span1>&nbsp;Kontak Kami</span1>
        </a>
        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    ...
    <div class="button-container">
            <span>Hubungi Kami Lewat Email</span>
    <div class="email-form">
        <i class="far fa-envelope email-icon"></i>
        <form action="#" method="post">
            <input type="email" name="email" placeholder="Type your email here" class="email-input" required>
...
<div class="kontak-container">
    ...
    <div class="right-container">
        <div class="address">
            <br>
            <span>H!PET Bandung</span>
            <span>(62)-459-8622</span>
